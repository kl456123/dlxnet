...
#ifndef DLXNET_STREAM_EXECUTOR_SHARED_MEMORY_CONFIG_H_
#define DLXNET_STREAM_EXECUTOR_SHARED_MEMORY_CONFIG_H_
...
#endif  // DLXNET_STREAM_EXECUTOR_SHARED_MEMORY_CONFIG_H_
