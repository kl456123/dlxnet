...
#ifndef DLXNET_STREAM_EXECUTOR_KERNEL_CACHE_CONFIG_H_
#define DLXNET_STREAM_EXECUTOR_KERNEL_CACHE_CONFIG_H_
...
#endif  // DLXNET_STREAM_EXECUTOR_KERNEL_CACHE_CONFIG_H_
