...
//    if (arg <= 0) {
//      return dlxnet::InvalidArgument("Arg must be positive");
//    } else {
//      return new Foo(arg);
//    }
//  }
...
// value.
#ifndef DLXNET_STREAM_EXECUTOR_LIB_STATUSOR_H_
#define DLXNET_STREAM_EXECUTOR_LIB_STATUSOR_H_

#include "dlxnet/core/platform/macros.h"
#include "dlxnet/stream_executor/lib/status.h"
#include "dlxnet/stream_executor/lib/statusor_internals.h"
...
class StatusOr : private internal_statusor::StatusOrData<T>,
 ...
 public:
  ...
  // of passing dlxnet::error::INTERNAL as a fallback.
...
template <typename T>
StatusOr<T>::StatusOr() : Base(Status(dlxnet::error::UNKNOWN, "")) {}
...
#endif  // DLXNET_STREAM_EXECUTOR_LIB_STATUSOR_H_
