...
#ifndef DLXNET_STREAM_EXECUTOR_LIB_STATUSOR_INTERNALS_H_
#define DLXNET_STREAM_EXECUTOR_LIB_STATUSOR_INTERNALS_H_
...
#endif  // DLXNET_STREAM_EXECUTOR_LIB_STATUSOR_INTERNALS_H_
