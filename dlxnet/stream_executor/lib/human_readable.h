...
#ifndef DLXNET_STREAM_EXECUTOR_LIB_HUMAN_READABLE_H_
#define DLXNET_STREAM_EXECUTOR_LIB_HUMAN_READABLE_H_
...
#endif  // DLXNET_STREAM_EXECUTOR_LIB_HUMAN_READABLE_H_
