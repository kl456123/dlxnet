...
#ifndef DLXNET_CORE_PLATFORM_RAW_CODING_H_
#define DLXNET_CORE_PLATFORM_RAW_CODING_H_

#include <string.h>
#include "dlxnet/core/platform/byte_order.h"
...
#endif  // DLXNET_CORE_PLATFORM_RAW_CODING_H_
