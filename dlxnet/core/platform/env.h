...
#ifndef DLXNET_CORE_PLATFORM_ENV_H_
#define DLXNET_CORE_PLATFORM_ENV_H_
...
#include "dlxnet/core/platform/file_system.h"
...
#define REGISTER_FILE_SYSTEM_UNIQ(ctr, env, scheme, factory)   \
  static ::dlxnet::register_file_system::Register<factory> \
      register_ff##ctr TF_ATTRIBUTE_UNUSED =                   \
          ::dlxnet::register_file_system::Register<factory>(env, scheme)

#define REGISTER_FILE_SYSTEM(scheme, factory) \
  REGISTER_FILE_SYSTEM_ENV(::dlxnet::Env::Default(), scheme, factory);

#endif  // DLXNET_CORE_PLATFORM_ENV_H_
