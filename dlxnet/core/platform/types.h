...
#ifndef DLXNET_CORE_PLATFORM_TYPES_H_
#define DLXNET_CORE_PLATFORM_TYPES_H_

#include <string>

#include "dlxnet/core/platform/platform.h"
#include "dlxnet/core/platform/tstring.h"

// Include appropriate platform-dependent implementations
#if defined(PLATFORM_GOOGLE) || defined(GOOGLE_INTEGRAL_TYPES)
#include "dlxnet/core/platform/google/integral_types.h"
...
#include "dlxnet/core/platform/default/integral_types.h"
#else
...
// Alias dlxnet::string to std::string.
using std::string;
...
#endif  // DLXNET_CORE_PLATFORM_TYPES_H_
