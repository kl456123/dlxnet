...
#ifndef DLXNET_CORE_PLATFORM_TSTRING_H_
#define DLXNET_CORE_PLATFORM_TSTRING_H_
...
namespace std {
template <>
struct hash<dlxnet::tstring> {
  size_t operator()(const dlxnet::tstring& o) const {
...
#endif  // DLXNET_CORE_PLATFORM_TSTRING_H_
