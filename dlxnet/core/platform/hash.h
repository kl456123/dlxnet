...
#ifndef DLXNET_CORE_PLATFORM_HASH_H_
#define DLXNET_CORE_PLATFORM_HASH_H_
...
//
// In particular, dlxnet::hash is not the identity function for pointers.
...
using StringPieceHasher = ::dlxnet::hash<StringPiece>;
...
#endif  // DLXNET_CORE_PLATFORM_HASH_H_
