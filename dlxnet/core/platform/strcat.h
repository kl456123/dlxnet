...
//
#ifndef DLXNET_CORE_PLATFORM_STRCAT_H_
#define DLXNET_CORE_PLATFORM_STRCAT_H_
...
class AlphaNum {
 public:
  ...
  AlphaNum(const dlxnet::string &str)          // NOLINT(runtime/explicit)
      : piece_(str) {}
#ifdef USE_TSTRING
  // TODO(dero): Temp guard to prevent duplicate declaration during tstring
  // migration.
  AlphaNum(const dlxnet::tstring &str)  // NOLINT(runtime/explicit)
      : piece_(str) {}
#endif
  template <typename A>
...
#endif  // DLXNET_CORE_PLATFORM_STRCAT_H_
