...
#ifndef DLXNET_CORE_PLATFORM_MEM_H_
#define DLXNET_CORE_PLATFORM_MEM_H_

// TODO(cwhipkey): remove this when callers use annotations directly.
#include "dlxnet/core/platform/dynamic_annotations.h"
...
#endif  // DLXNET_CORE_PLATFORM_MEM_H_
