...
#ifndef DLXNET_CORE_PLATFORM_DEFAULT_TEST_BENCHMARK_H_
#define DLXNET_CORE_PLATFORM_DEFAULT_TEST_BENCHMARK_H_
...
#define BENCHMARK(n)                                            \
  static ::dlxnet::testing::Benchmark* TF_BENCHMARK_CONCAT( \
      __benchmark_, n, __LINE__) TF_ATTRIBUTE_UNUSED =          \
      (new ::dlxnet::testing::Benchmark(#n, (n)))
...
#endif  // DLXNET_CORE_PLATFORM_DEFAULT_TEST_BENCHMARK_H_
