...
#ifndef DLXNET_CORE_PLATFORM_DEFAULT_NOTIFICATION_H_
#define DLXNET_CORE_PLATFORM_DEFAULT_NOTIFICATION_H_
...
#endif  // DLXNET_CORE_PLATFORM_DEFAULT_NOTIFICATION_H_
