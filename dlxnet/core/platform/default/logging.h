...
#ifndef DLXNET_CORE_PLATFORM_DEFAULT_LOGGING_H_
#define DLXNET_CORE_PLATFORM_DEFAULT_LOGGING_H_
...
#define _TF_LOG_INFO \
  ::dlxnet::internal::LogMessage(__FILE__, __LINE__, ::dlxnet::INFO)
#define _TF_LOG_WARNING \
  ::dlxnet::internal::LogMessage(__FILE__, __LINE__, ::dlxnet::WARNING)
#define _TF_LOG_ERROR \
  ::dlxnet::internal::LogMessage(__FILE__, __LINE__, ::dlxnet::ERROR)
#define _TF_LOG_FATAL \
  ::dlxnet::internal::LogMessageFatal(__FILE__, __LINE__)
...
#define VLOG_IS_ON(lvl)                                                     \
  (([](int level, const char* fname) {                                      \
    static const bool vmodule_activated =                                   \
        ::dlxnet::internal::LogMessage::VmoduleActivated(fname, level); \
...
#define VLOG(level)                                              \
  ...
  ? (void)0                                                      \
  : ::dlxnet::internal::Voidifier() &                        \
          ::dlxnet::internal::LogMessage(__FILE__, __LINE__, \
                                             dlxnet::INFO)
...
#define DVLOG(verbose_level) \
  while (false && (verbose_level) > 0) ::dlxnet::internal::LogMessageNull()
#endif
...
#define LOGGING_INTERNAL_STATEFUL_CONDITION(kind, condition, arg)   \
  for (bool logging_internal_stateful_condition_do_log(condition);  \
    ...
    for (static ::dlxnet::internal::Log##kind##State            \
...
#define TF_DEFINE_CHECK_OP_IMPL(name, op)                                 \
  ...
  inline string* name##Impl(const T1& v1, const T2& v2,                   \
    ...
    if (TF_PREDICT_TRUE(v1 op v2))                                        \
      ...
      return ::dlxnet::internal::MakeCheckOpString(v1, v2, exprtext); \
  }                                                                       \
...
#define CHECK_OP_LOG(name, op, val1, val2)                            \
  while (::dlxnet::internal::CheckOpString _result =              \
             ::dlxnet::internal::name##Impl(                      \
                 ::dlxnet::internal::GetReferenceableValue(val1), \
                 ::dlxnet::internal::GetReferenceableValue(val2), \
                 #val1 " " #op " " #val2))                            \
  ::dlxnet::internal::LogMessageFatal(__FILE__, __LINE__) << *(_result.str_)
...
#define CHECK_NOTNULL(val)                                 \
  ::dlxnet::internal::CheckNotNull(__FILE__, __LINE__, \
...
#endif  // DLXNET_CORE_PLATFORM_DEFAULT_LOGGING_H_
