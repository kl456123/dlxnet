...
#ifndef DLXNET_CORE_PLATFORM_DEFAULT_TRACING_IMPL_H_
#define DLXNET_CORE_PLATFORM_DEFAULT_TRACING_IMPL_H_
...
#endif  // DLXNET_CORE_PLATFORM_DEFAULT_TRACING_IMPL_H_
