...
#ifndef DLXNET_CORE_PLATFORM_MUTEX_H_
#define DLXNET_CORE_PLATFORM_MUTEX_H_
...
#include "dlxnet/core/platform/google/mutex_data.h"
...
#include "dlxnet/core/platform/default/mutex_data.h"
#else
...
class SCOPED_LOCKABLE mutex_lock {
 public:
  typedef ::dlxnet::mutex mutex_type;
...
// Include appropriate platform-dependent implementation details of mutex etc.
#if defined(PLATFORM_GOOGLE)
#include "dlxnet/core/platform/google/mutex.h"
#elif defined(PLATFORM_POSIX) || defined(PLATFORM_POSIX_ANDROID) ||    \
    defined(PLATFORM_GOOGLE_ANDROID) || defined(PLATFORM_POSIX_IOS) || \
    defined(PLATFORM_GOOGLE_IOS) || defined(PLATFORM_WINDOWS)
#include "dlxnet/core/platform/default/mutex.h"
#else
#error Define the appropriate PLATFORM_<foo> macro for this platform
#endif

#endif  // DLXNET_CORE_PLATFORM_MUTEX_H_
