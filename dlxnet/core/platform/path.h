...
#ifndef DLXNET_CORE_PLATFORM_PATH_H_
#define DLXNET_CORE_PLATFORM_PATH_H_
...
namespace io {
namespace internal {
string JoinPathImpl(std::initializer_list<dlxnet::StringPiece> paths);
}
...
string CleanPath(dlxnet::StringPiece path);
...
void ParseURI(dlxnet::StringPiece uri, dlxnet::StringPiece* scheme,
              dlxnet::StringPiece* host, dlxnet::StringPiece* path);

// Creates a URI from a scheme, host, and path. If the scheme is empty, we just
// return the path.
string CreateURI(dlxnet::StringPiece scheme, dlxnet::StringPiece host,
                 dlxnet::StringPiece path);
...
#endif  // DLXNET_CORE_PLATFORM_PATH_H_
