...
#ifndef DLXNET_LIB_GTL_MANUAL_CONSTRUCTOR_H_
#define DLXNET_LIB_GTL_MANUAL_CONSTRUCTOR_H_
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size)                          \
  typename dlxnet::gtl::internal::AlignType<TF_LIB_GTL_ALIGN_OF(T), \
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size) \
  dlxnet::gtl::internal::AlignType<Size * sizeof(T)>::result
...
#endif  // DLXNET_LIB_GTL_MANUAL_CONSTRUCTOR_H_
