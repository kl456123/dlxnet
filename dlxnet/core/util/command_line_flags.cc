...
bool ParseStringFlag(dlxnet::StringPiece arg, dlxnet::StringPiece flag,
...
bool ParseInt32Flag(dlxnet::StringPiece arg, dlxnet::StringPiece flag,
...
bool ParseInt64Flag(dlxnet::StringPiece arg, dlxnet::StringPiece flag,
...
bool ParseBoolFlag(dlxnet::StringPiece arg, dlxnet::StringPiece flag,
...
bool ParseFloatFlag(dlxnet::StringPiece arg, dlxnet::StringPiece flag,
...
Flag::Flag(const char* name, dlxnet::int32* dst, const string& usage_text)
    : name_(name),
      type_(TYPE_INT32),
...
Flag::Flag(const char* name, dlxnet::int64* dst, const string& usage_text)
    : name_(name),
      type_(TYPE_INT64),
