...
#ifndef DLXNET_CORE_UTIL_COMMAND_LINE_FLAGS_H
#define DLXNET_CORE_UTIL_COMMAND_LINE_FLAGS_H
...
// std::vector<dlxnet::Flag> flag_list = {
...
//
// dlxnet::port::InitMain(usage.c_str(), &argc, &argv);
...
#endif  // DLXNET_CORE_UTIL_COMMAND_LINE_FLAGS_H
