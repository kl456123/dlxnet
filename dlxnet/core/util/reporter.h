...
#ifndef DLXNET_CORE_UTIL_REPORTER_H_
#define DLXNET_CORE_UTIL_REPORTER_H_
...
#include "dlxnet/core/util/test_log.pb.h"
...
class TestReporter {
 public:
  ...
  // TODO(b/32704451): Don't just ignore the ::dlxnet::Status object!
...
#endif  // DLXNET_CORE_UTIL_REPORTER_H_
