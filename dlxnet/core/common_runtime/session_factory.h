...
#ifndef DLXNET_CORE_COMMON_RUNTIME_SESSION_FACTORY_H_
#define DLXNET_CORE_COMMON_RUNTIME_SESSION_FACTORY_H_
...
#endif  // DLXNET_CORE_COMMON_RUNTIME_SESSION_FACTORY_H_
