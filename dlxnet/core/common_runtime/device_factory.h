...
#ifndef DLXNET_CORE_COMMON_RUNTIME_DEVICE_FACTORY_H_
#define DLXNET_CORE_COMMON_RUNTIME_DEVICE_FACTORY_H_
...
#define INTERNAL_REGISTER_LOCAL_DEVICE_FACTORY(device_type, device_factory, \
        ctr, ...)                    \
    static ::dlxnet::dfactory::Registrar<device_factory>                  \
...
#endif  // DLXNET_CORE_COMMON_RUNTIME_DEVICE_FACTORY_H_
