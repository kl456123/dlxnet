...
#ifndef DLXNET_CORE_FRAMEWORK_SELECTIVE_REGISTRATION_H_
#define DLXNET_CORE_FRAMEWORK_SELECTIVE_REGISTRATION_H_
...
#endif  // DLXNET_CORE_FRAMEWORK_SELECTIVE_REGISTRATION_H_
