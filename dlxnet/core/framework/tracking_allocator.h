...
#ifndef DLXNET_CORE_FRAMEWORK_TRACKING_ALLOCATOR_H_
#define DLXNET_CORE_FRAMEWORK_TRACKING_ALLOCATOR_H_
...
}  // end namespace dlxnet

#endif  // DLXNET_CORE_FRAMEWORK_TRACKING_ALLOCATOR_H_
