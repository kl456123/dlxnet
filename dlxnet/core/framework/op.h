...
#ifndef DLXNET_CORE_FRAMEWORK_OP_H_
#define DLXNET_CORE_FRAMEWORK_OP_H_
...
class OpDefBuilderWrapper<true> {
 public:
  ...
  const ::dlxnet::OpDefBuilder& builder() const { return builder_; }

 private:
  mutable ::dlxnet::OpDefBuilder builder_;
};
...
#define REGISTER_OP_UNIQ(ctr, name)                                          \
  static ::dlxnet::register_op::OpDefBuilderReceiver register_op##ctr    \
      TF_ATTRIBUTE_UNUSED =                                                  \
          ::dlxnet::register_op::OpDefBuilderWrapper<SHOULD_REGISTER_OP( \
              name)>(name)
...
#define REGISTER_SYSTEM_OP_UNIQ(ctr, name)                                \
  static ::dlxnet::register_op::OpDefBuilderReceiver register_op##ctr \
      TF_ATTRIBUTE_UNUSED =                                               \
          ::dlxnet::register_op::OpDefBuilderWrapper<true>(name)

}  // namespace dlxnet

#endif  // DLXNET_CORE_FRAMEWORK_OP_H_
