...
#ifndef DLXNET_CORE_FRAMEWORK_TYPE_TRAITS_H_
#define DLXNET_CORE_FRAMEWORK_TYPE_TRAITS_H_
...
namespace std {
// template <>
// class numeric_limits<dlxnet::qint8>
    // : public numeric_limits<dlxnet::int8> {};
// template <>
// class numeric_limits<dlxnet::quint8>
    // : public numeric_limits<dlxnet::uint8> {};
// template <>
// class numeric_limits<dlxnet::qint16>
    // : public numeric_limits<dlxnet::int16> {};
// template <>
// class numeric_limits<dlxnet::quint16>
    // : public numeric_limits<dlxnet::uint16> {};
// template <>
// class numeric_limits<dlxnet::qint32>
    // : public numeric_limits<dlxnet::int32> {};

// Specialize is_signed for quantized types.
// template <>
// struct is_signed<dlxnet::qint8> : public is_signed<dlxnet::int8> {};
// template <>
// struct is_signed<dlxnet::quint8> : public is_signed<dlxnet::uint8> {};
// template <>
// struct is_signed<dlxnet::qint16> : public is_signed<dlxnet::int16> {};
// template <>
// struct is_signed<dlxnet::quint16> : public is_signed<dlxnet::uint16> {};
// template <>
// struct is_signed<dlxnet::qint32> : public is_signed<dlxnet::int32> {};

}  // namespace std

#endif  // DLXNET_CORE_FRAMEWORK_TYPE_TRAITS_H_
